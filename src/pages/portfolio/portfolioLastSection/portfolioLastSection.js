...
import "./portfolioLastSection.css";
...
function PortfolioLastSection() {
  return (
    <Container fluid>
      <Row
        className="lastSectionPortfolio"
        // style={{backgroundColor:'#FFB400' , marginTop:'55px'}}
      >
        <h2
          className="lastSectionPorfolioHeadings"
          //  style={{fontWeight:'800' , textAlign:'center', padding:'47px 0px', fontSize:'35px'}}
        >
...
export default PortfolioLastSection;

...
function PortfolioLastSection(){
    return(
        <Container fluid>
        <Row style={{backgroundColor:'#FFB400' , marginTop:'55px'}}>

<h2 style={{fontWeight:'800' , textAlign:'center', padding:'47px 0px', fontSize:'35px'}}>Have a Project in Mind? <br/>
Let’s Get Building!</h2>

      ...
      <Row style={{ justifyContent: "center" }}>
        <Col lg={4} className="text-md-center-service">
          <h2
            ...
            // style={{fontWeight:'bold', marginTop:'70px', marginBottom:'12px'}}
          >
            F.A.Q.
          </h2>

          <img src={line} alt="Vector Image" className="vector-img mb-3" />
          <p
            className="questionSectionParagraph"
        ...
        <Col
          className="accordians mb-5"
          // style={{marginTop:'93px' , marginLeft:'26px' , marginBottom:'80px'}}
          lg={5}
          md={11}
          sm={10}
          xs={10}

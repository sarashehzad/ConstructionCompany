...
function AboutProject(){
    ...
    <Container>
        <Row style={{justifyContent:'center' , marginTop:'69px'}}>
            <Col lg={6}>
                <h2 style={{fontWeight:'bold'}}>About this Project</h2>
                <img src={line} alt="Vector Image" className="vector-img" /> 
                <p style={{marginTop:'17px'}}>Lectus erat, consectetur eu sapien eget rhoncus consectetur sem. Proin cursus, dolor a mollis consectetur, risus dolor fermentum  massa, a commodo elit dui sit amet risus.</p>
                <ul>
            ...
            <Row style={{justifyContent:'center'}}>
                ...
                <p>
                Lorem ipsum dolor sit consectetur adipiscing elit. Nullam lectus erat, consectetur eu sapien eget rhoncus consectetur sem.</p>
<p> Proin cursus, dolor a mollis consectetur, risus dolor fermentum massa, a commodo elit dui sit amet risus. Maecenas ornare nisl a tortor ultrices bibendum. Nulla fermentum, metus quis sodales tristique, augue mauris molestie augue non feugiat ligula neque nec felis.</p>

...
<h1 style={{ fontWeight: "bold" }}>Construction Inc</h1>
<p style={{margin:'20px 0px'}}>LLorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam lectus erat <br/> consectetur eu sapien eget, rhoncus consectetur sem. </p>
<Button style={{color:'white', padding:'10px 40px' , backgroundColor:'#FFB400', border: "none", fontWeight:'bold'  }} onClick={() => console.log("Button clicked!")} value="VIEW OUR WORK"></Button>
   ...
   <Row  style={{justifyContent:'center', marginTop:'26px' , marginBottom:'50px'}}>
   <Col lg={3}>
   <YellowBoxWithContent
            logo={home4}
            title ="Building Construction"

...
function HomeMiddleSection(){
    return(
        ...
        <Container fluid>
        <Row>
    <Col style={{marginTop:'40px', backgroundColor:'#FFB400'}} lg={4}>
...
<YellowBoxWithContent
    ...
    <Col lg={8} className="p-0 home-cutom-middle-section">
                    <Row className="project-p mt-5 p-0" style={{margin: '13px'}}>
...
<Col className="p-0">
    <div style={{display:'flex', justifyContent:'space-evenly'}} className="black-bg-1">
        <h3 style={{ fontWeight: 'bold' , margin:'17px 0px'}}>Get Free Consultation</h3>
        <Button style={{color:'#FFB400', padding:'8px 55px' , border: "4px solid #FFB400", backgroundColor:'#2A2A2A' }} onClick={() => console.log("Button clicked!")} value="ONLINE ESTIMATE FORM"></Button>
    </div>
</Col>

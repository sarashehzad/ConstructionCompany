...
<YellowBoxWithContent
      ...
      <Row
        className="aboutParagrapghSection"
        //  style={{justifyContent:'center', marginTop:'70px' ,  marginBottom:'56px'}}
      >
        <div
          className="aboutParagrapghSectionHeading"
          //  style={{textAlign:'center' , marginBottom:'37px'}}
        >
          <h2 className="b-heading mt-2">About Divi Construction</h2>
          <img src={line} alt="vector-img" className="vector-img"></img>
        </div>
        <Col lg={5}>
          <p className="hero-custom-p text-secondary ">

      ...
      <Row>
        ...
        >
          ...
          <div
            ...
            // style={{justifyContent:'end', marginRight:'110px', display: 'flex',  marginBottom:'30px'}}
          >
            <Button
              style={{
                color: "black",
        ...
        <Col
          ...
          // style={{marginTop:'93px' , marginLeft:'26px', marginBottom:'20px'}}
          lg={5}
          md={11}
          sm={10}
          xs={10}
        ...
        <Col
          className="map-section p-0"
          //  style={{padding:'0px'}}
          lg={12}
          md={12}
          sm={12}
        >
          <img src={Map} alt="map-img" className="map-img"></img>
        </Col>
      </Row>
    </Container>
  );

    ...
    <Container fluid>
      <Row>
        <Col className="p-0" lg={9}>
          <div className="contact-img">
            <div className="contact-main-section-text">
              <h1 className="vectorr" style={{ fontWeight: "bold" }}>
                Contact Us
              </h1>
              <p
        ...
        <Col
          ...
          // style={{backgroundColor:'#FFB400' ,padding:'35px 12px'}}
          lg={3}
        >
          <h4
            className="contact-box-main-heading"
          ...
          <div
            ...
            //  style={{margin:'25px 23px'}}
          >
            <h6 className="b-heading">Our Office</h6>
            <p>
              1234 Divi St. #1000, San Francisc, CA <br /> 93251
            </p>
          </div>
          <div className="contact-box-heading">
            <h6 className="b-heading">Open Office Hours</h6>
            <p>
              M-F: 9am – 6pm <br /> S-S: 10am – 4pm
            </p>
          </div>
          <div className="contact-box-heading">
            <h6 className="b-heading">Get in Touch</h6>
            <p>
      ...
      <Row style={{ margin: "20px 0px" }}>
        <div className="lower-section">
          <h3 className="b-heading">
            <span style={{ color: "#FFB400" }}>Call: (541) 931-3526</span>{" "}
            <br />

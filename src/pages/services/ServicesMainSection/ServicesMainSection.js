...
<h1 className="vectorr" style={{ fontWeight: "bold" }}>Our Construction <br/> Services</h1>
...
<YellowBoxWithContent
   ...
   <Row style={{boxShadow:'2px 2px 5px 0px rgba(0, 0, 0, 0.6)', position:'relative'}}>
   <div  className="lower-section">
        <h2 style={{ fontWeight: "bold", justifyContent:'center', alignItems:'center', display:'flex'}}>Get a Quote For Your Project</h2>
        <div className="services-custom-button">
        <Button style={{color:'#FFB400', padding:'10px 25px' , backgroundColor:'white', border: "4px solid #FFB400",  }} onClick={() => console.log("Button clicked!")} value="FREE QUOTE"></Button>
        </div>
    </div>
</Row>
